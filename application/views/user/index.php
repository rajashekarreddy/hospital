...
<html lang="en">
        ...
        <script>
            $(document).ready(function(){
                ...
                jQuery("#customers_grid_tbl").jqGrid431({
                    url:'<?php echo site_url();?>records/getRecords',
                    datatype: "json",
                    mtype:"POST",
                    colNames:['ID','Name','DOB','Done by Dr.','Father\'s Name','Mother\'s Name','Home Address','Telephone No.','Immunisation','Edit'],
                    colModel:[
                        {name:'id',index:'id',width:'10%'},
                        {name:'name',index:'name',width:'10%'},
                        {name:'dob',index:'dob',width:'10%'},
                        {name:'done_by_dr',index:'done_by_dr',width:'10%'},
                        {name:'fathers_name',index:'fathers_name',width:'10%'},
                        {name:'mothers_name',index:'mothers_name',width:'10%'},
                        {name:'home_address',index:'home_address',width:'20%'},
                        {name:'telephone_no',index:'telephone_no',width:'20%'},
                        {name:'immunisation',index:'immunisation',width:'15%'},
    ...
    <body OnResize="refreshWindow()">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span2" style="float:right;text-align:right">
                    <a class="btn btn-primary" href="<?php echo site_url();?>records/newRecord">New Record</a>
                </div>
            </div>
            <div class="row-fluid">
                <div>&nbsp;</div>
        ...
        <div class="modal hide fade in" id="myCustomer"  style="display:none">
            <form name="customer_form" id="customer_form" method="post" >
                ...
                <div class="modal-body">
                    ...
                    <div><label>Primary Contact Number: <input type="text" name="phone_number1"></label></div>
                    <div><label>Alternate Contact Number: <input type="text" name="phone_number2"></label></div>
                </div>
